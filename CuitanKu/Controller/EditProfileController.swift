...
class EditProfileController : UITableViewController {
    ...
    func updateProfileImage() {
        ...
        UserService.shared.updateProfileImage(image: image) { profileImageUrl in
            self.user.profilImageUrl = profileImageUrl
            self.delegate?.controller(self, wantsToUpdate: self.user)
    ...
    func configureNavigationBar() {
        navigationController?.navigationBar.barTintColor = .cuitankuTosca
...
extension EditProfileController : UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        //print("DEBUG: UPDATE PHOTO PROFILE")
...
extension EditProfileController : EditProfileFooterDelegate {
    func handleLogout() {
        let alert = UIAlertController(title: nil, message: "yakin mau keluar sekarang?", preferredStyle: .actionSheet)
